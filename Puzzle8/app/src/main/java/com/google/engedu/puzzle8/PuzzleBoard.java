    ...
    public ArrayList<PuzzleBoard> neighbours() {
        ...
        for(int [] XY:NEIGHBOUR_COORDS)
        {
            ...
            if( x>=0 && x<NUM_TILES && y>=0 && y<NUM_TILES )
            {
                    ...
                    board.swapTiles(XYtoIndex(x,y),XYtoIndex(posX,posY));
